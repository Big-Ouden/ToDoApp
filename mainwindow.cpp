...
void MainWindow::onAbout()
{
    QString aboutText = tr(
        "<h2>ToDoApp v1.0.0</h2>"
        "<p><b>Gestionnaire de tâches hiérarchique multiplateforme</b></p>"
        "<hr>"
        "<p><b>Auteurs :</b></p>"
        "<ul>"
        "<li>Développeur principal</li>"
        "<li>Projet académique - Université</li>"
        "</ul>"
        "<p><b>Fonctionnalités :</b></p>"
        "<ul>"
        "<li>Création de tâches et sous-tâches avec hiérarchie</li>"
        "<li>Gestion des priorités et statuts</li>"
        "<li>Dates d'échéance avec alertes</li>"
        "<li>Sauvegarde/Chargement au format JSON</li>"
        ...
        "<li>Del : Supprimer</li>"
        "<li>Ctrl+D : Marquer complétée</li>"
        ...
        "<p><b>Crédits :</b></p>"
        "<ul>"
        "<li><b>Framework :</b> Qt6 (LGPL v3) - <a href='https://www.qt.io'>qt.io</a></li>"
        "<li><b>Icônes :</b> Material Design Icons - <a href='https://materialdesignicons.com'>materialdesignicons.com</a></li>"
        "<li><b>Documentation :</b> Doxygen - <a href='https://www.doxygen.org'>doxygen.org</a></li>"
        "</ul>"
        "<hr>"
        "<p><b>Licence :</b> MIT License</p>"
        "<p style='font-size:9px;'>Copyright © 2025. Tous droits réservés.</p>"
        "<p style='font-size:9px;'>Développé avec Qt %1</p>"
    ).arg(QT_VERSION_STR);
