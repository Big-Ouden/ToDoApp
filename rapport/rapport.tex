...
% Logo ENSIIE
\includegraphics[width=0.4\textwidth]{images/ensiie-logo.pdf}\\[2cm]

% Titre
{\huge\bfseries Rapport de projet\\[0.5cm]}
{\LARGE Application de gestion de tâches\\[0.3cm]}
{\LARGE\textbf{ToDoApp}}\\[2cm]

% Informations du cours
{\large\textbf{Cours : Langages et Applications Orientés Objets Avancés (LAOA)}}\\[1.5cm]
...
\begin{figure}[p]
\centering
\includegraphics[angle=90,scale=0.18,keepaspectratio]{images/diagramme_de_classe.pdf}
